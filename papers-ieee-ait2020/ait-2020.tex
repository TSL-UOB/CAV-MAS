...
\todo[inline]{This is similar to standardised testing, e.g. Euro-NCAP CPNA-25~\cite{EURO-NCAP}}
...
\todo[inline]{Specify what the trigger radius is: 15 cells using city-block measure, note that this is a model parameter}
